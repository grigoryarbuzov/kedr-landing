        ...
        <div className="flex items-center justify-between py-3 md:py-4">
          ...
          >
            ...
            <div className="hidden md:block">
              <div className="text-lg font-display font-bold text-frost-800 tracking-wider">КЕДР</div>
              <div className="text-xs text-frost-500 tracking-wide">База отдыха</div>
            </div>
          </a>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 text-center px-6 max-w-3xl">
        ...
        <h1 className={`mt-6 md:mt-8 font-display text-white leading-tight ${mounted ? "animate-fade-up-1" : "opacity-0"}`}>
          <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-semibold tracking-wide">
            Окажись на природе,
          </span>
          <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-semibold tracking-wide mt-1 text-frost-200">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-5 border border-frost-100">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://instagram.com/kedr.novosibirsk" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-pink-50 hover:bg-pink-100 transition-colors group">
                  <div className="w-8 h-8 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                  ...
                  <span className="text-sm font-medium text-frost-700">Instagram</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-6 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-lg font-display font-bold text-white tracking-wider">КЕДР</span>
              <span className="text-sm text-frost-300 ml-2">База отдыха</span>
            </div>
          </div>
          <div className="flex items-center gap-6 text-sm">
            ...
            <a href="https://instagram.com/kedr.novosibirsk" target="_blank" rel="noopener noreferrer" className="hover:text-frost-400 transition-colors">Instagram</a>
          </div>
        </div>
